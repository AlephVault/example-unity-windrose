        ...
        namespace States
        {
            public class MapState
            {
                ...
                public class MapObjectState
                {
                    ...
                    public readonly Behaviours.Objects.Positionable RelatedComponent;
                    public readonly uint Width;
                    public readonly uint Height;
                    ...
                    public MapObjectState(Behaviours.Objects.Positionable relatedComponent, uint x, uint y, uint width, uint height, SolidnessStatus solidness)
                    {
