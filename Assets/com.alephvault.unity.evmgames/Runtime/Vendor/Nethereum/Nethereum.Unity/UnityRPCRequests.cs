...
/*
Autogenerated file from AlephVault.Unity.EVMGames.Nethereum.RPC
*/
...
namespace AlephVault.Unity.EVMGames.Nethereum.JsonRpc.UnityClient
{
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Web3.Web3ClientVersion _web3ClientVersion;
        ...
        {
            _web3ClientVersion = new AlephVault.Unity.EVMGames.Nethereum.RPC.Web3.Web3ClientVersion(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Web3.Web3Sha3 _web3Sha3;
        ...
        {
            _web3Sha3 = new AlephVault.Unity.EVMGames.Nethereum.RPC.Web3.Web3Sha3(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.KeyPair.ShhNewKeyPair _shhNewKeyPair;
        ...
        {
            _shhNewKeyPair = new AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.KeyPair.ShhNewKeyPair(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.KeyPair.ShhAddPrivateKey _addPrivateKey;
        ...
        {
            _addPrivateKey = new AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.KeyPair.ShhAddPrivateKey(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.ShhVersion _shhVersion;
        ...
        {
            _shhVersion = new AlephVault.Unity.EVMGames.Nethereum.RPC.Shh.ShhVersion(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalListAccounts _personalListAccounts;
        ...
        {
            _personalListAccounts = new AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalListAccounts(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalLockAccount _personalLockAccount;
        ...
        {
            _personalLockAccount = new AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalLockAccount(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalNewAccount _personalNewAccount;
        ...
        {
            _personalNewAccount = new AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalNewAccount(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalSignAndSendTransaction _personalSignAndSendTransaction;
        ...
        {
            _personalSignAndSendTransaction = new AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalSignAndSendTransaction(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalUnlockAccount _personalUnlockAccount;
        ...
        {
            _personalUnlockAccount = new AlephVault.Unity.EVMGames.Nethereum.RPC.Personal.PersonalUnlockAccount(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetListening _netListening;
        ...
        {
            _netListening = new AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetListening(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetPeerCount _netPeerCount;
        ...
        {
            _netPeerCount = new AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetPeerCount(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetVersion _netVersion;
        ...
        {
            _netVersion = new AlephVault.Unity.EVMGames.Nethereum.RPC.Net.NetVersion(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthAccounts _ethAccounts;
        ...
        {
            _ethAccounts = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthAccounts(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthCoinBase _ethCoinBase;
        ...
        {
            _ethCoinBase = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthCoinBase(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGasPrice _ethGasPrice;
        ...
        {
            _ethGasPrice = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGasPrice(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetBalance _ethGetBalance;
        ...
        {
            _ethGetBalance = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetBalance(null);
        }

        public IEnumerator SendRequest(System.String address, AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetCode _ethGetCode;
        ...
        {
            _ethGetCode = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetCode(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetStorageAt _ethGetStorageAt;
        ...
        {
            _ethGetStorageAt = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthGetStorageAt(null);
        }

        public IEnumerator SendRequest(System.String address, AlephVault.Unity.EVMGames.Nethereum.Hex.HexTypes.HexBigInteger position, AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthProtocolVersion _ethProtocolVersion;
        ...
        {
            _ethProtocolVersion = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthProtocolVersion(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthSign _ethSign;

        public EthSignUnityRequest(string url, JsonSerializerSettings jsonSerializerSettings = null):base(url, jsonSerializerSettings)
        {
            _ethSign = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthSign(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthSyncing _ethSyncing;
        ...
        {
            _ethSyncing = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.EthSyncing(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleByBlockHashAndIndex _ethGetUncleByBlockHashAndIndex;
        ...
        {
            _ethGetUncleByBlockHashAndIndex = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleByBlockHashAndIndex(null);
        }

        public IEnumerator SendRequest(System.String blockHash, AlephVault.Unity.EVMGames.Nethereum.Hex.HexTypes.HexBigInteger uncleIndex)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleByBlockNumberAndIndex _ethGetUncleByBlockNumberAndIndex;
        ...
        {
            _ethGetUncleByBlockNumberAndIndex = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleByBlockNumberAndIndex(null);
        }

        public IEnumerator SendRequest(Nethereum.RPC.Eth.DTOs.BlockParameter blockParameter, AlephVault.Unity.EVMGames.Nethereum.Hex.HexTypes.HexBigInteger uncleIndex)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleCountByBlockHash _ethGetUncleCountByBlockHash;
        ...
        {
            _ethGetUncleCountByBlockHash = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleCountByBlockHash(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleCountByBlockNumber _ethGetUncleCountByBlockNumber;
        ...
        {
            _ethGetUncleCountByBlockNumber = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Uncles.EthGetUncleCountByBlockNumber(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthCall _ethCall;

        public EthCallUnityRequest(string url, JsonSerializerSettings jsonSerializerSettings = null):base(url, jsonSerializerSettings)
        {
            _ethCall = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthCall(null);
        }

        public IEnumerator SendRequest(Nethereum.RPC.Eth.DTOs.CallInput callInput, AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthEstimateGas _ethEstimateGas;
        ...
        {
            _ethEstimateGas = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthEstimateGas(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByBlockHashAndIndex _ethGetTransactionByBlockHashAndIndex;
        ...
        {
            _ethGetTransactionByBlockHashAndIndex = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByBlockHashAndIndex(null);
        }

        public IEnumerator SendRequest(System.String blockHash, AlephVault.Unity.EVMGames.Nethereum.Hex.HexTypes.HexBigInteger transactionIndex)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByBlockNumberAndIndex _ethGetTransactionByBlockNumberAndIndex;
        ...
        {
            _ethGetTransactionByBlockNumberAndIndex = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByBlockNumberAndIndex(null);
        }

        public IEnumerator SendRequest(Nethereum.Hex.HexTypes.HexBigInteger blockNumber, AlephVault.Unity.EVMGames.Nethereum.Hex.HexTypes.HexBigInteger transactionIndex)
        {
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByHash _ethGetTransactionByHash;
        ...
        {
            _ethGetTransactionByHash = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionByHash(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionCount _ethGetTransactionCount;
        ...
        {
            _ethGetTransactionCount = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionCount(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionReceipt _ethGetTransactionReceipt;
        ...
        {
            _ethGetTransactionReceipt = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthGetTransactionReceipt(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthSendRawTransaction _ethSendRawTransaction;
        ...
        {
            _ethSendRawTransaction = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthSendRawTransaction(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthSendTransaction _ethSendTransaction;
        ...
        {
            _ethSendTransaction = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthSendTransaction(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthGetWork _ethGetWork;
        ...
        {
            _ethGetWork = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthGetWork(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthHashrate _ethHashrate;
        ...
        {
            _ethHashrate = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthHashrate(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthMining _ethMining;
        ...
        {
            _ethMining = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthMining(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthSubmitHashrate _ethSubmitHashrate;
        ...
        {
            _ethSubmitHashrate = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthSubmitHashrate(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthSubmitWork _ethSubmitWork;
        ...
        {
            _ethSubmitWork = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Mining.EthSubmitWork(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterChangesForEthNewFilter _ethGetFilterChangesForEthNewFilter;
        ...
        {
            _ethGetFilterChangesForEthNewFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterChangesForEthNewFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterChangesForBlockOrTransaction _ethGetFilterChangesForBlockOrTransaction;
        ...
        {
            _ethGetFilterChangesForBlockOrTransaction = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterChangesForBlockOrTransaction(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterLogsForBlockOrTransaction _ethGetFilterLogsForBlockOrTransaction;
        ...
        {
            _ethGetFilterLogsForBlockOrTransaction = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterLogsForBlockOrTransaction(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterLogsForEthNewFilter _ethGetFilterLogsForEthNewFilter;
        ...
        {
            _ethGetFilterLogsForEthNewFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetFilterLogsForEthNewFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetLogs _ethGetLogs;
        ...
        {
            _ethGetLogs = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthGetLogs(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewBlockFilter _ethNewBlockFilter;
        ...
        {
            _ethNewBlockFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewBlockFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewFilter _ethNewFilter;
        ...
        {
            _ethNewFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewPendingTransactionFilter _ethNewPendingTransactionFilter;
        ...
        {
            _ethNewPendingTransactionFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthNewPendingTransactionFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthUninstallFilter _ethUninstallFilter;
        ...
        {
            _ethUninstallFilter = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Filters.EthUninstallFilter(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileLLL _ethCompileLLL;
        ...
        {
            _ethCompileLLL = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileLLL(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileSerpent _ethCompileSerpent;
        ...
        {
            _ethCompileSerpent = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileSerpent(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileSolidity _ethCompileSolidity;
        ...
        {
            _ethCompileSolidity = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthCompileSolidity(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthGetCompilers _ethGetCompilers;
        ...
        {
            _ethGetCompilers = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Compilation.EthGetCompilers(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthBlockNumber _ethBlockNumber;
        ...
        {
            _ethBlockNumber = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthBlockNumber(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsByHash _ethGetBlockWithTransactionsByHash;
        ...
        {
            _ethGetBlockWithTransactionsByHash = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsByHash(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByHash _ethGetBlockWithTransactionsHashesByHash;
        ...
        {
            _ethGetBlockWithTransactionsHashesByHash = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByHash(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsByNumber _ethGetBlockWithTransactionsByNumber;
        ...
        {
            _ethGetBlockWithTransactionsByNumber = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsByNumber(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockTransactionCountByHash _ethGetBlockTransactionCountByHash;
        ...
        {
            _ethGetBlockTransactionCountByHash = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockTransactionCountByHash(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockTransactionCountByNumber _ethGetBlockTransactionCountByNumber;
        ...
        {
            _ethGetBlockTransactionCountByNumber = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockTransactionCountByNumber(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByNumber _ethGetBlockWithTransactionsHashesByNumber;
        ...
        {
            _ethGetBlockWithTransactionsHashesByNumber = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByNumber(null);
        }
    ...
    {
        private readonly AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthFeeHistory _ethFeeHistory;
        ...
        {
            _ethFeeHistory = new AlephVault.Unity.EVMGames.Nethereum.RPC.Eth.Transactions.EthFeeHistory(null);
        }
