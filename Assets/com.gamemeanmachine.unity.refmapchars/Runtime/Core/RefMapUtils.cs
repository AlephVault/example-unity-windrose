...
///   textures (all of them are separate
/// </summary>
public static class RefMapUtils
{
    /// <summary>
    ///   Provides a target texture and the relevant parts of a character
    ...
    public static void Paste(
        ...
        RefMapSource shoulder, RefMapSource longShirt, RefMapSource chest, RefMapSource shirt, RefMapSource boots,
        RefMapSource pants, RefMapSource body, Texture2D maskD, Texture2D maskLRU, Texture2D maskLR,
        Texture2D maskU, bool bootsOverPants = false
    )
    {
        ...
        AddIfPresent(elements, longShirt?.ToTexture2DSource());
